...
> **2026-08-08 新交接入口：先完整阅读 `HANDOVER_CODEX_20260808.md`。**
> 本文件下方主体是截至 2026-07-31 的历史权威状态，其中大量 Git、环境和优先级陈述已被
> 新交接更新；只有新交接明确指向时才引用旧章节。所有者 2026-08-01 的补充原话逐字保存在
> `.qoder/specs/dolly_owner_addendum_20260801.txt`。最终目标是完成整个 Dolly 项目，所有者描述的
> Memory、调度和学习效果必须通过研究、比较、消融与重复验证来决定设计，不能把模糊 idea 或
> 两个早期 AI 规格直接当最终架构。
