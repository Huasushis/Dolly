...
pub fn load_worker_start_config(
    ...
    Ok(WorkerStartConfig {
        ...
        origin_component_id: premise.origin_component_id.clone(),
        origin_component_revision: premise.origin_component_revision,
        origin_component_digest: premise.origin_component_digest.clone(),
